//
//  WaterFallFlowLayoutUsageController.m
...
static NSString *cellId = @"WaterFallFlowLayoutCollectionViewCell";

@interface WaterFallFlowLayoutUsageController () <UICollectionViewDelegate, UICollectionViewDataSource, TKWaterFallFlowLayoutDelegate>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) NSMutableArray<NSNumber *> *heightArray;
@property (nonatomic, assign) NSInteger page;
@end

@implementation WaterFallFlowLayoutUsageController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    WaterFallFlowLayoutCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:WaterFallFlowLayoutCollectionViewCell.class forCellWithReuseIdentifier:cellId];
    }
